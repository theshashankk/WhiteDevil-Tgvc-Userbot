...
Sᴛᴀʀᴛ ᴛʜᴇ ᴜsᴇʀʙᴏᴛ ᴀɴᴅ sᴇɴᴅ !record ᴛᴏ ᴀ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ
ᴇɴᴀʙʟᴇᴅ ɢʀᴏᴜᴘ ᴄʜᴀᴛ ᴛᴏ sᴛᴀʀᴛ ʀᴇᴄᴏʀᴅɪɴɢ ғᴏʀ 30 sᴇᴄᴏɴᴅs
"""
import os
import asyncio
import subprocess
...
async def record_and_send_opus():
    ...
    status = await client.send_message(chat_id, "1/3 Rᴇᴄᴏʀᴅɪɴɢ...")
    ...
    await status.edit_text("2/3 Tʀᴀɴsᴄᴏᴅɪɴɢ...")
    ffmpeg.input(
        record_raw,
        format='s16le',
        acodec='pcm_s16le',
